...
class AttendanceHistoryResponseModel {
  final List<AttendencyDatum> data;
  final Meta meta;
  ...
  factory AttendanceHistoryResponseModel.fromMap(Map<String, dynamic> json) =>
      AttendanceHistoryResponseModel(
        data: List<AttendencyDatum>.from(
            json["data"].map((x) => AttendencyDatum.fromMap(x))),
...
class AttendencyDatum {
  ...
  factory AttendencyDatum.fromJson(String str) =>
      AttendencyDatum.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AttendencyDatum.fromMap(Map<String, dynamic> json) => AttendencyDatum(
        id: json["id"],

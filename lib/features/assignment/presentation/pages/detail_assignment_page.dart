...
import 'package:bengkod_mobile_app/features/assignment/data/models/response/assignment_response_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: BlocBuilder<DetailAssignmentBloc, DetailAssignmentState>(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SpaceHeight(10),
                            BlocConsumer<DetailAssignmentBloc,
                                DetailAssignmentState>(
                              listener: (context, state) {
                                state.maybeWhen(
                                  orElse: () {},
                                  downloadFileSuccess: (message) {
                                ...
                                return state.maybeWhen(loading: () {
                                  ...
                                  return Button.filled(
                                    onPressed: () async {
                                      ...
                                      // context.read<DetailAssignmentBloc>().add(
                                      //       DetailAssignmentEvent.downloadFile(
                                      //           urlQuestion),
                                      // );

                                      await AssignmentRemoteDatasource()
                                          .launchInBrowser(urlQuestion);
                                    },
                                        ...
                                        orElse: () {
                                          return Button.filled(
                                            onPressed: () async {
                                              ...
                                              context
                                                  .read<DetailAssignmentBloc>()
                                                  .add(
                                                    DetailAssignmentEvent
                                                        .downloadFile(
                                                            urlAnswer),
                                                  );
                                            },
